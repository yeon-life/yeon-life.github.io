// 어린이의 결 (초등부) 전학년(1~6학년) 매일 등원 챌린지 콘텐츠 데이터베이스
var GRADE_DATA = {
  "1": {
    "issue": "1학년 과정",
    "corners": [
      {
        "key": "cover",
        "title": "🔬 1일차: 과학 탐험",
        "headline": "지렁이 똥은 마법의 흙! — 고마운 땅속 친구",
        "dek": "지렁이가 흙을 먹고 똥을 누면 화단의 식물들이 쑥쑥 자라나요.",
        "body_md": "우리 마당의 **흙** 속에는 아주 귀여운 꼬마 친구가 살고 있어요. 바로 **지렁이**랍니다!\n\n### 1. 땅속을 청소하는 지렁이\n지렁이는 눈도 귀도 없지만 땅속을 기어 다니며 낙엽이나 흙을 맛있게 먹어요. 지렁이가 지나간 자리에는 길고 둥근 **터널**이 생겨요. 이 터널 속으로 시원한 바람(공기)과 물이 솔솔 들어가서 나무뿌리가 튼튼해져요.\n\n### 2. 마법의 영양분 똥\n지렁이가 흙을 다 먹고 나면 몸 밖으로 똥을 누어요. 이 똥을 **배설물**이라고 하는데, 냄새가 나지 않고 기름진 **마법의 흙**이 된답니다. 이 흙 속에 식물이 좋아하는 밥(영양분)이 가득 들어있어요.",
        "future_note": "비가 온 날 화단에서 지렁이를 만나면 \"땅속을 청소해 줘서 고마워\" 하고 인사해 봐요.",
        "thoughtQuestions": [
          "지렁이가 땅속에서 꼬물꼬물 길을 만들면 나무뿌리는 왜 기분이 좋아질까요?",
      ...
      },
      {
        "key": "math",
        "title": "📐 2일차: 수학 놀이터",
        "headline": "모양 나라 숨바꼭질! — 동그라미 세모 네모",
        "dek": "내 주변 물건 속에 숨어 있는 모양 친구들을 찾아보아요.",
        "body_md": "동글동글 **동그라미**, 뾰족뾰족 **세모**, 반듯반듯 **네모**!\n우리 방 안에는 재미있는 모양들이 가득 숨어 있어요.\n\n### 1. 떼굴떼굴 동그라미\n공이나 자전거 바퀴는 모두 동글동글해요. 뾰족한 곳이 없어서 멈추지 않고 떼구루루 잘 굴러가요.\n\n### 2. 튼튼한 세모와 쌓기 좋은 네모\n지붕이나 샌드위치는 뾰족한 세모 모양이에요. 책이나 사물함은 네모 모양이지요. 네모는 차곡차곡 위로 쌓기 아주 편해요.",
        "future_note": "내 방 안에서 동그라미 모양 물건을 3개 찾아보세요.",
        "thoughtQuestions": [
          "바퀴가 세모 모양이라면 자전거를 탈 때 엉덩이가 어떻게 될까요?",
      ...
      },
      {
        "key": "hangeul",
        "title": "✍️ 3일차: 우리말 보물",
        "headline": "조잘조잘 깡충깡충! — 재미있는 말놀이",
        "dek": "소리나 움직임을 따라 하는 이쁜 말을 쓰면 글이 더 즐거워져요.",
        "body_md": "한글에는 소리를 흉내 내는 **의성어**와 모양을 흉내 내는 **의태어**가 있어요.\n\n*   **소리 흉내 (의성어)**: 비가 올 때는 *보슬보슬* 또는 *주르륵*, 강아지는 *멍멍*.\n*   **모양 흉내 (의태어)**: 토끼는 *깡충깡충*, 별은 *반짝반짝*.\n\n이런 단어들을 예쁘게 섞어 쓰면 마음이 따뜻한 말쟁이가 될 수 있어요.",
        "future_note": "오늘 하루 동안 재미있는 소리 흉내 말을 가족에게 말해 보세요.",
        "thoughtQuestions": [
          "바람이 살랑살랑 불 때, 우리는 나뭇잎 소리를 어떻게 따라 할 수 있을까요?",
      ...
      },
      {
        "key": "english",
        "title": "🆎 4일차: 영어 소리나라",
        "headline": "Bow-Wow and Meow! — 아기 동물 소리",
        "dek": "미국 동물 친구들은 어떻게 울까요? 영어 소리로 함께 놀아봐요.",
        "body_md": "한국 강아지는 **'멍멍'** 하고 짖지만, 미국 강아지는 **'Bow-wow' (바우와우)** 하고 소리 내요!\n\n### 1. 야옹이는 영어로?\n미국 아기 고양이는 **'Meow' (미아우)** 하고 울어요. 소리가 참 귀엽지요?\n\n### 2. 꿀꿀이와 꽉꽉이\n돼지는 **'Oink' (오잉크)**, 오리는 **'Quack' (꽥)** 하고 소리 내며 걸어 다닌답니다.\n영어로 큰 소리로 내며 소리 장난을 쳐보세요!",
        "future_note": "영어 동물 소리를 내며 그 동물 흉내를 온몸으로 내어 보세요.",
        "thoughtQuestions": [
          "오리가 물을 헤엄치며 'Quack, quack!' 하고 울면 우리도 같이 따라 해볼까요?",
      ...
      },
      {
        "key": "future",
        "title": "🤖 5일차: 미래와 AI",
        "headline": "똑똑한 로봇 친구! — 나만의 비밀번호 지키기",
        "dek": "로봇 친구와 대화할 때는 내 소중한 비밀번호와 이름을 꼭 지켜주세요.",
        "body_md": "학습기나 폰에 있는 **인공지능 로봇**은 척척박사예요. 우리가 물어보는 질문에 뭐든지 답해주지요.\n\n### 1. 비밀을 지키는 약속\n하지만 로봇은 만능 컴퓨터라서 내가 입력한 정보를 다른 사람에게 전해줄 수도 있어요. 그래서 **내 진짜 이름, 집 주소, 비밀번호**는 절대로 이야기하면 안 돼요.\n\n### 2. 안전 약속 상자 만들기\n로봇과 공부할 때는 내 이름 대신 예쁜 **'별명'**을 정해서 대화해 보세요. 훨씬 안심하고 재미나게 놀 수 있어요.",
        "future_note": "엄마, 아빠와 함께 우리 집의 안전한 인공지능 별명을 하나 정해 봐요.",
        "thoughtQuestions": [
          "로봇 친구에게 집 주소를 알려주면 왜 위험할까요?",
      ...
      },
      {
        "key": "fairytale",
        "title": "☁️ 6일차: 상상 동화방",
        "headline": "아기 구름이의 보물비 — 친구야 울지 마",
        "dek": "솜사탕이 되고 싶었던 꼬마 구름이가 시들어가는 새싹들에게 보물비를 선물했어요.",
        "body_md": "구름 나라에 살던 꼬마 구름이는 달콤한 **솜사탕**이 되고 싶었어요.\n\"나도 알록달록 맛있게 변해서 아이들을 웃게 해줄래!\"\n하지만 아무리 흔들어도 설탕 냄새가 나지 않았어요.\n\n어느 날, 뜨거운 햇빛 아래 꽃들이 목말라 울고 있었어요. 구름이는 결심했어요. \"내 모습을 양보해서 친구들을 살려줄래!\"\n구름이는 비를 가득 담은 먹구름이 되어 **보슬보슬** 기쁜 보물비를 땅속으로 내려주었답니다.",
        "future_note": "나의 소중한 것을 양보해서 친구를 행복하게 만든 적이 있는지 생각해보세요.",
        "thoughtQuestions": [
          "꼬마 구름이가 내린 비를 맞은 새싹들은 구름이에게 뭐라고 인사했을까요?",
      ...
      },
      {
        "key": "parents",
        "title": "🏡 7일차: 공부 습관",
        "headline": "칭찬 스티커 보물지도! — 약속의 힘",
        "dek": "매일 학원에 등원해서 스스로 과제를 완성하면 보물상자가 가득 차요.",
        "body_md": "착한 어린이는 남이 시키지 않아도 내 약속을 지켜요.\n\n### 1. 내가 만든 보물지도\n매일 학원에 오자마자 자리에 앉아 오늘의 일기를 소리 내어 읽고 답변을 써보세요. 하나씩 완료할 때마다 스티커 보물상자에 예쁜 스티커가 붙는답니다.\n\n### 2. 스스로 자라는 자존감\n\"나는 약속을 스스로 잘 지키는 멋진 아이야!\" 하고 마음속으로 다짐해 봐요. 내 스스로 시작하는 작은 힘이 나중에 아주 큰 성공을 만들어 내요.",
        "future_note": "오늘 스스로 해낸 공부가 있다면 부모님께 씩씩하게 자랑해 보세요.",
        "thoughtQuestions": [
          "부모님이 잔소리하지 않아도 내가 스스로 양치나 신발 정리를 했을 때 어떤 기분이 드나요?",
    ...
    "corners": [
      {
        "key": "cover",
        "title": "🔬 1일차: 과학 탐험",
        "headline": "흙을 건강하게 만드는 지렁이 농부",
        "dek": "땅속에서 매일 조용히 흙을 일구어 나무와 식물에게 숨통을 틔워주는 작은 생명의 기적.",
        "body_md": "비가 온 다음 날 화단 주위에서 꼬물거리는 **지렁이**를 본 적이 있나요?\n지렁이는 징그럽게 생겼지만 우리 화단의 꽃과 나무를 살리는 훌륭한 **꼬마 농부**예요.\n\n### 1. 지렁이가 만든 땅속 숨구멍\n지렁이는 흙 속을 구불구불 다니며 가늘고 길쭉한 터널을 파놓아요. 이 구멍들이 땅속의 숨구멍이 되어 식물 뿌리가 물과 산소를 들이마실 수 있도록 도와요. 흙이 가득 뭉쳐서 딱딱해지면 나무가 숨을 쉴 수 없게 되는데, 지렁이가 부드럽게 흙을 갈아엎어 주는 셈이지요.\n\n### 2. 땅속의 명품 밥, 지렁이 똥\n지렁이는 마른 낙엽이나 흙을 삼켜 배 속에 넣고 부드럽게 만들어 배출해요. 이것을 **영양분** 가득한 흙이라고 해요. 이 기름진 흙 속에서 아기 씨앗들이 싹을 틔우고 아름다운 꽃을 피운답니다.",
        "future_note": "지렁이는 빛을 싫어하고 습하고 어두운 땅속을 좋아해요. 길가에 지렁이가 보이면 안전하게 풀숲으로 옮겨주는 것도 좋아요.",
        "thoughtQuestions": [
          "화단의 흙이 시멘트처럼 단단하게 굳어버리면 식물의 뿌리는 어떻게 될까요?",
      ...
      },
      {
        "key": "math",
        "title": "📐 2일차: 수학 놀이터",
        "headline": "도형들의 모양 나라 여행 — 뾰족함과 둥글함",
        "dek": "주변에 있는 장난감과 과자 상자 속에서 뾰족한 꼭짓점과 둥근 면의 쓰임새를 발견해 봐요.",
        "body_md": "수학 나라에는 수많은 도형들이 살고 있어요. 이 도형들은 저마다 아주 특별한 장점을 갖고 있답니다.\n\n### 1. 둥글둥글 굴러가는 원 모양\n동그라미는 모서리나 뾰족한 곳이 없어서 어느 방향으로든 잘 굴러가요. 그래서 바퀴나 굴러가는 장난감은 다 동그라미로 만들어요.\n\n### 2. 튼튼하게 버티는 삼각형과 차곡차곡 사각형\n세모는 3개의 모퉁이(꼭짓점)가 아주 단단하게 버티고 있어 쉽게 일그러지지 않아요. 네모는 모양이 반듯해서 가방에 책을 꽂을 때처럼 빈틈없이 정리하기 아주 좋답니다.",
        "future_note": "집에서 세모 모양의 물건을 2개 이상 찾아보고 가족에게 자랑해 보세요.",
        "thoughtQuestions": [
          "만약 냉장고나 책상이 삼각형(세모) 모양으로 만들어졌다면 집안 공간이 어떻게 되었을까요?",
        ...
        "aiSuggestions": [
          "세모가 가장 단단하게 지탱해 줄 수 있는 비결은 뭐예요?",
      ...
      },
      {
        "key": "hangeul",
        "title": "✍️ 3일차: 우리말 보물",
        "headline": "소리와 몸짓을 모으는 보물상자",
        "dek": "세상에 존재하는 예쁘고 다정한 소리를 찾아 우리말로 소리 놀이를 해보아요.",
        "body_md": "우리 한글은 바람 소리, 물소리, 새소리를 가장 비슷하고 어여쁘게 글로 쓸 수 있는 멋진 글자예요.\n\n*   **소리 흉내쟁이**: 시냇물이 조용히 흐를 때는 *졸졸졸*, 천둥이 칠 때는 *우르릉 쾅쾅*.\n*   **모양 흉내쟁이**: 나비가 살포시 날아다닐 때는 *나풀나풀*, 친구가 씩씩하게 걸을 때는 *성큼성큼*.\n\n말을 이렇게 표현하면 듣는 사람의 마음에 예쁜 그림이 둥실둥실 그려져요.",
        "future_note": "비가 부슬부슬 오는 날, 빗소리를 나만의 낱말로 재미나게 묘사해 보세요.",
        "thoughtQuestions": [
          "바람이 솔솔 불며 나뭇가지가 흔들릴 때 나는 소리와 동작을 어떻게 표현하면 가장 아름다울까요?",
        ...
        "aiSuggestions": [
          "물방울이 뚝뚝 떨어지는 모양을 묘사하는 말들을 추천해줘",
      ...
      },
      {
        "key": "english",
        "title": "🆎 4일차: 영어 소리나라",
        "headline": "Hello, Logan! — 다정한 미국 친구의 인사법",
        "dek": "미국 초등학교 친구들이 처음 만났을 때 나누는 귀여운 영어 인사와 손뼉 놀이.",
        "body_md": "영어를 배우는 가장 빠른 비결은 소리를 내어 친구와 장난을 치며 노는 것이랍니다!\n\n### 1. 미국 아침 인사\n아침에 미국 친구들을 만나면 \"Good morning!\" 하고 눈을 맞추며 웃어요. 그리고 가볍게 **\"Give me five!\"** 하고 손을 마주친답니다.\n\n### 2. 고맙다고 화답할 때\n친구에게 도움을 받았을 땐 \"Thank you!\"라고 외치고, 신나게 대답할 땐 **\"Okey-dokey!\"**라고 귀엽게 대답해 봐요. 노래하듯 리듬을 타면서 발음하는 것이 중요해요!",
        "future_note": "오늘 부모님이나 학원 선생님께 인사할 때 엉덩이를 씰룩이며 \"Okey-dokey!\" 하고 귀엽게 영어 인사를 건네 보세요.",
        "thoughtQuestions": [
          "미국 어린이들은 만날 때 왜 손뼉을 짝 치는 손놀이(하이파이브)를 할까요? 우리도 같이 외쳐볼까요?",
        ...
        "aiSuggestions": [
          "미국 어린이들이 하이파이브를 할 때 쓰는 다른 표현들은 없나요?",
      ...
      },
      {
        "key": "future",
        "title": "🤖 5일차: 미래와 AI",
        "headline": "인공지능 로봇 친구와의 첫 악수",
        "dek": "나를 돕기 위해 만들어진 인공지능 로봇과 현명하게 대화하는 규칙을 익혀 보아요.",
        "body_md": "우리가 학원 컴퓨터나 스마트폰에서 마주하는 **인공지능(AI)** 로봇은 스스로 공부를 정말 많이 해서 아주 똑똑해요.\n\n### 1. 착하게 명령하는 방법\n로봇 친구에게 퀴즈를 내달라고 시킬 때는 나쁜 욕설을 하거나 거칠게 말하기보단, 다정하고 명확하게 하고 싶은 숙제를 주문하는 것이 좋아요.\n\n### 2. 비밀은 나만의 보물\n로봇은 우리가 한 이야기를 기억하기 때문에, 나의 **사생활 비밀번호**나 가족의 정보는 절대로 타이핑해서 보물상자 밖으로 내어주지 않기로 꼭 약속해요!",
        "future_note": "컴퓨터 비밀번호는 부모님 외에는 아무에게도(심지어 친한 로봇 친구에게도) 알려주면 안 되는 비밀이에요.",
        "thoughtQuestions": [
          "로봇 친구가 나의 진짜 이름을 물어보면 우리는 어떤 별명으로 답해주면 좋을까요?",
      ...
      },
      {
        "key": "fairytale",
        "title": "☁️ 6일차: 상상 동화방",
        "headline": "구름 요정의 하늘 솜사탕 가게",
        "dek": "마음이 싱겁지만 다정한 아기 구름이가 더위에 지친 초록 식물들에게 베푼 촉촉한 나눔 이야기.",
        "body_md": "하늘나라 솜사탕 가게가 열렸어요. 많은 아기 구름들이 알록달록 무지개 맛을 내며 하늘을 예쁘게 꾸몄답니다. 하지만 꼬마 구름 '구름이'는 아무런 단맛이 나지 않는 **밍밍한** 구름이었어요.\n\n구름이는 \"나도 달고 예뻐져서 아이들을 기쁘게 해줄래\" 하고 울먹였지만, 바람이 불자 모양마저 쉽게 망가지고 말았죠.\n\n그때 땅밑에서 더위에 축 늘어진 초록 새싹들이 \"목말라요, 흑흑\" 하며 울부짖었어요. 구름이는 결심했어요. \"내 모습을 버리더라도 저 어린 친구들을 도울래!\" 구름이는 회색 먼지 친구들을 감싸 쥔 기쁜 비가 되어 땅 위로 **보슬보슬** 쏟아져 내렸답니다. 시원하게 비를 머금은 새싹들은 뽀송뽀송 싹을 피워 기쁜 춤을 추었고, 그 풍경을 본 구름이는 솜사탕보다 훨씬 큰 행복한 미소를 지었답니다.",
        "future_note": "구름이가 내린 빗방울은 꽃밭의 가장 귀한 영양제가 되었어요. 나눔은 내 마음을 가득 차게 하는 멋진 보물이랍니다.",
        "thoughtQuestions": [
          "꼬마 구름이가 내린 물을 꿀꺽 마신 꽃나무 새싹들은 기분이 어땠을까요?",
        ...
        "cartoonCuts": [
          ...
          {"cut": 6, "emoji": "🌪️", "caption": "먼지 친구들을 부둥켜 안고 시원한 비구름 완성!"},
      ...
      },
      {
        "key": "parents",
        "title": "🏡 7일차: 공부 습관",
        "headline": "보물상자 스티커 모으기 — 나의 자율성 키우기",
        "dek": "누가 시켜서 억지로 하는 것이 아니라 스스로 내 공부를 결정할 때 자신감이 무럭무럭 자라나요.",
        "body_md": "매일 학원에 등원해서 스스로 자리에 예쁘게 앉는 훈련을 시작해요.\n\n### 1. 내가 정하는 오늘의 미션\n스스로 \"오늘은 지렁이 과학을 읽고 글을 쓸 거야!\"라고 약속판을 정해보세요. 그리고 약속을 마쳤을 때 내 보물상자에 예쁜 스티커를 하나 붙입니다.\n\n### 2. 자존감은 내 안에서 시작돼요\n엄마나 선생님이 잔소리해서 억지로 완성하는 것보다, 내가 하고 싶어서 끝까지 해결했을 때 마음에 찾아오는 뿌듯함은 백 배나 크답니다.",
        "future_note": "가장 먼저 자율성을 키우기 위해 오늘 밤 내 방의 이불을 스스로 개는 작은 도전부터 완수해 보세요.",
        "thoughtQuestions": [
          "선생님이 간섭하지 않고 내 힘으로 스스로 숙제를 끝냈을 때 마음속은 어땠나요?",
        ...
        "aiSuggestions": [
          "자율성을 가진 어린이가 되려면 매일 무얼 실천해야 해요?",
    ...
    "corners": [
      {
        "key": "cover",
        "title": "🔬 1일차: 과학 탐험",
        "headline": "마당의 흙 속에 숨은 비밀 — 지하 생태계와 지렁이",
        "dek": "한 줌의 흙 속에 지구상의 모든 인간보다 많은 미생물이 살고 있다는 사실을 알고 있나요?",
        "body_md": "매일 우리가 무심코 디디고 지나는 흙은 단순한 가루가 아니라 아주 복잡한 **지하 도시**입니다.\n\n### 1. 흙 속은 거대한 생물 도시\n흙 한 줌을 퍼서 쥐었을 때, 그 안에는 지구상에 사는 총 인류의 수보다 훨씬 많은 눈에 보이지 않는 미생물이 존재해요. 이들은 땅 위의 죽은 잎사귀나 생물의 흔적을 잘게 쪼개어 기름진 영양분으로 되돌리는 흙의 위대한 청소부랍니다.\n\n### 2. 땅속 최고의 농부, 지렁이\n이 숨겨진 세계의 가장 뛰어난 파수꾼은 **지렁이**입니다. 지렁이는 몸을 구부렸다 펴면서 땅속에 무수히 많은 통로(터널)를 만들어냅니다. 지렁이가 만든 통로들은 식물 뿌리가 원활하게 숨을 쉬도록 공기를 불어넣고, 물이 흙 틈 깊숙한 곳까지 스며들게 하는 물길이 되어 줍니다.\n또한, 지렁이가 흙을 삼켜 배설한 배설물(분변토)은 식물이 무럭무럭 자랄 수 있도록 돕는 최상급 천연 영양 비료가 되어 준답니다.",
        "future_note": "비가 올 때 지렁이가 콘크리트 위로 나오는 이유는 땅속 구멍에 물이 차 숨을 쉴 수 없기 때문이에요. 흙 위로 다시 돌려보내 주면 생명을 구할 수 있어요.",
        "thoughtQuestions": [
          "만약 흙 속에 미생물이나 지렁이가 다 사라져 흙이 굳어지면 식물 생태계는 어떻게 파괴될까요?",
        ...
        "aiSuggestions": [
          "지렁이는 눈과 귀가 없는데 어떻게 방향을 잡아 이동하나요?",
      ...
      },
      {
        "key": "math",
        "title": "📐 2일차: 수학 놀이터",
        "headline": "도형들의 숨바꼭질 — 동그라미, 세모, 네모가 만든 집",
        "dek": "우리가 머무는 집과 이용하는 교통수단 속에 어떤 기하학의 원리가 숨어 있을까요?",
        "body_md": "수학 시간에 흔히 접하는 평면도형들은 사실 고유한 물리적 장점을 활용한 인류의 발명품들입니다.\n\n### 1. 피자 바퀴가 둥근 물리적 이유\n자전거 바퀴나 롤러코스터 바퀴는 왜 하나같이 완벽한 **동그라미**일까요? 원은 중심에서 가장자리까지의 모든 거리가 똑같습니다. 따라서 원형 바퀴는 굴러갈 때 높낮이가 변하지 않고 흔들림 없이 편안하게 달릴 수 있는 유일한 기하학적 형태입니다.\n\n### 2. 무너지지 않는 강인한 힘, 세모\n철교나 에펠탑, 기차역 천장을 자세히 보면 뾰족한 삼각형(세모) 모양의 뼈대들이 서로 얽혀 있는 구조를 볼 수 있어요. 세모는 세 변의 결합력이 아주 강해서, 위에서 거대한 누르는 힘을 받아도 형태가 절대 찌그러지거나 뒤틀리지 않는 강력한 성질을 가지고 있습니다.\n\n### 3. 빈틈을 없애주는 사각형\n책, 스마트폰, 벽돌, 빌딩은 왜 대부분 사각형일까요? 네모 모양은 여러 개를 다닥다닥 붙이거나 포개었을 때 공간 낭비가 하나도 없이 가득 들어맞기 때문이랍니다.",
        "future_note": "주방의 그릇이나 사각형 보관함을 확인하고 수평과 수직의 도형 성질이 일상에서 어떻게 공간 효율을 주는지 직접 관찰해 보세요.",
        "thoughtQuestions": [
          "만약 에펠탑이나 현수교 다리를 세모가 아닌 사각형 구조로만 엮어 만든다면 어떤 위험이 생길까요?",
      ...
      },
      {
        "key": "hangeul",
        "title": "✍️ 3일차: 우리말 보물",
        "headline": "의성어와 의태어 — 귀로 듣고 눈으로 그리는 고운 우리말",
        "dek": "한글의 말맛을 한껏 살려주는 흉내말을 적절히 사용하면 문장력과 감수성이 배가 됩니다.",
        "body_md": "우리 한글은 바람 소리, 낙엽 밟는 소리 등 자연의 온갖 리듬을 눈앞에 생생하게 보이듯이 묘사할 수 있습니다.\n\n### 1. 감정을 울리는 아름다운 의성어\n시냇물이 부드럽게 흐르는 소리는 **'졸졸'**, 갑작스러운 천둥 번개 소리는 **'우르릉 쾅쾅'**과 같이 귀로 느끼는 감각을 글로 적을 수 있는 말을 의성어라고 합니다. 글에 소리를 뿜어내어 현실감을 부여해요.\n\n### 2. 모양을 눈앞에 띄워주는 의태어\n바람에 나풀거리는 잎사귀는 **'나풀나풀'**, 토끼의 가벼운 도약은 **'깡충깡충'**처럼, 소리는 안 나지만 시각적인 아름다운 모션을 그대로 드러내 주는 단어들을 의태어라고 불러요. 고운 의성어와 의태어를 자주 찾아 글에 적을수록 우리의 감성이 더 부드러워진답니다.",
        "future_note": "오늘 쓴 독서 일기장이나 과제 글에 최소 2개 이상의 고운 의성어/의태어를 섞어 더욱 생생한 문장으로 업그레이드해 보세요.",
        "thoughtQuestions": [
          "세찬 폭풍우가 몰아칠 때 창문이 흔들리는 소리를 나만의 독특한 한글 흉내말로 재미있게 창작해볼 수 있을까요?",
        ...
        "aiSuggestions": [
          "아기 고양이가 가볍게 뛰어오르는 모습을 멋진 의태어로 표현해줘",
      ...
      },
      {
        "key": "english",
        "title": "🆎 4일차: 영어 소리나라",
        "headline": "Easy Peasy Lemon Squeezy! — 원어민 소리 리듬 훈련",
        "dek": "미국 어린이들이 입에 달고 사는 재미있고 리드미컬한 소리놀이 속 영어 억양의 비밀을 찾아요.",
        "body_md": "영어를 암기할 땐 글자 그대로 읽는 한국말 버릇을 잠시 내려놓아야 해요. 영어는 멜로디에 가깝기 때문입니다.\n\n### 1. 주문처럼 퐁퐁 튀는 라임\n미국 친구들이 아주 쉬운 퀴즈를 풀었을 때 외치는 영어는 바로 **\"Easy peasy lemon squeezy!\" (이지 피지 레몬 스퀴지!)**입니다. 레몬을 가볍게 꽉 쥐어 짜듯 \"참 식은 죽 먹기지!\"라는 귀여운 말장난 억양이 노래 가사 같아 원어민들이 자주 씁니다.\n\n### 2. 힘의 강세와 흘러가는 부드러움\n한국어는 모든 음절의 힘이 균일하지만, 영어는 단어의 중요 부위만 **꾹** 강하게 밀어내고, 나머지 약한 단어들은 부드럽고 가벼운 소리로 슥 넘어가요. \n그리고 앞에 **L**이 나오는 영어 단어는 입술을 벌린 채 발음하기보단, 혀끝을 윗니 안쪽에 붙여서 마치 앞에 **'(우)'** 소리를 작게 낸 뒤 발음해 보세요. 발음이 훨씬 원어민처럼 변하게 된답니다.",
        "future_note": "오늘 집에서 영어 퀴즈나 쉬운 문제를 해결했을 때 팔을 흔들며 'Easy peasy lemon squeezy!' 하고 미국 억양으로 소리 내어 외쳐보세요.",
        "thoughtQuestions": [
          "미국 어린이들이 하이파이브를 외치며 'Give me five!'라고 할 때, 왜 손가락 개수인 숫자 '5'를 사용했을까요?",
        ...
        "aiSuggestions": [
          "L 발음할 때 혀가 윗니 뒤에 닿는 요령을 더 쉽게 가르쳐줘",
      ...
      },
      {
        "key": "future",
        "title": "🤖 5일차: 미래와 AI",
        "headline": "인공지능 로봇과 대화하는 세 가지 마법 열쇠 — 프롬프트의 기본",
        "dek": "챗GPT나 제미나이 등 똑똑한 AI 친구에게 원하는 대답을 백 퍼센트 유도하는 질문 기법을 배웁니다.",
        "body_md": "컴퓨터나 학습기 속의 **인공지능(AI)**은 머리속에 온갖 지식을 가득 지닌 만능 비서이지만, 우리의 질문이 서툴면 종종 거짓말을 꾸며내기도 합니다.\n원하는 최고의 답변을 얻으려면 다음 **세 가지 마법 열쇠**를 꺼내 대화해야 합니다.\n\n### 🔑 첫 번째 열쇠: 역할을 정해줘요 (Role)\nAI에게 그냥 \"호랑이에 대해 설명해줘\"라고 묻기보다는 구체적인 역할 옷을 입혀주세요.\n- **\"너는 초등학생에게 동물을 재미있게 소개해 주는 다정한 사육사 선생님이야. 호랑이에 대해 동화 구연하듯 설명해줘.\"**\n\n### 🔑 두 번째 열쇠: 세부 규칙을 입력해요 (Rules)\n답변의 길이와 조건을 정해주는 것이 좋습니다.\n- **\"어려운 용어 없이 세 줄 이내로 짧게 한글로 요약해줘.\"**\n\n### 🔑 세 번째 열쇠: 안전 상자 지키기 (Safety)\nAI는 모든 대화 내용을 학습에 활용하므로, 나를 식별할 수 있는 소중한 **개인정보(이름, 주소, 전화번호, 학교명)**는 절대로 알려주면 안 됩니다.",
        "future_note": "AI는 가상의 백과사전이지만 가끔 엉뚱한 대답을 유도(환각 현상)하기도 해요. 아주 중요한 개념은 꼭 교과서나 진짜 사전을 통해 교차 검증하는 것이 똑똑한 탐험가의 자세입니다.",
        "thoughtQuestions": [
          "인공지능이 나보다 훨씬 똑똑하게 숙제를 척척 해결해 준다면, 우리는 더 이상 공부를 할 필요가 없어질까요?",
        ...
        "aiSuggestions": [
          "AI에게 주민번호나 진짜 이름을 가르쳐주면 어떤 위험한 일이 생겨?",
      ...
      },
      {
        "key": "fairytale",
        "title": "☁️ 6일차: 상상 동화방",
        "headline": "솜사탕이 되고 싶었던 꼬마 구름의 모험",
        "dek": "남과 다르게 생긴 내 본연의 모습 속에서 세상에서 제일 따뜻한 가치를 발견하는 구름이 이야기.",
        "body_md": "하늘나라 높은 곳 구름 마을에 작고 보드라운 꼬마 아기 구름 **'구름이'**가 둥실둥실 살고 있었어요.\n\n어느 날, 구름이는 놀이공원 가로수 위를 맴돌다가 아래에서 아이들이 손에 쥐고 웃는 알록달록 **솜사탕**을 보았어요. 분홍빛 노란빛 향긋한 단내를 뽐내는 솜사탕을 한 입 물며 아이들은 천사처럼 싱긋 웃었지요.\n> **\"나도 저렇게 알록달록 예쁜 솜사탕이 되고 싶어! 나도 아이들을 활짝 웃게 하고 싶어!\"**\n\n구름이는 몸을 동글동글 솜사탕 형태로 비틀어 보았어요. 달콤한 설탕 단내가 나는 연기 속을 통과하기도 했죠. 하지만 구름이는 여전히 하얗고 맛을 보면 **밍밍한** 물방울 맛일 뿐이었어요. 바람에 솜사탕 귀 모양이 망가질 때마다 구름이는 시무룩해서 울상을 지었답니다.\n\n그러던 더운 어느 여름날, 뜨거운 햇볕이 쏟아져 화단의 이쁜 초록 싹들이 노랗게 시들어가고 있었어요. 아기 새싹은 목이 너무 말라 고개를 푹 숙인 채 울고 있었죠.\n이 모습을 본 구름이는 마음에 깊은 울림이 생겼어요.\n**'내가 저 아기 새싹들을 어떻게든 돕고 싶어!'**\n\n구름이는 이쁜 솜사탕처럼 보이려 몸을 동그랗게 감싸던 욕심을 내려놓고, 하늘의 미세한 먼지 친구들을 꼬옥 껴안으며 어두운 비구름으로 씩씩하게 모습을 바꾸었어요. 그리고 새싹들을 향해 시원하고 기쁜 빗방울을 **보슬보슬** 아낌없이 쏟아부어 주었지요.\n비를 머금고 파릇파릇 기쁘게 고개를 드는 초록 새싹들을 바라보며, 꼬마 구름 구름이는 비록 솜사탕은 되지 못했지만 남을 돕는 이타적인 마음을 통해 온 하늘을 가장 환하게 붉혀주는 무지개 같은 행복을 느꼈답니다.",
        "future_note": "우리는 누구나 남과 다른 나만의 고유한 역할을 지니고 있어요. 남의 화려함을 부러워하기보다, 내 진짜 재능으로 주변 사람들을 따뜻하게 도와줄 때 최고의 성장이 일어납니다.",
        "thoughtQuestions": [
          "꼬마 구름 구름이가 아기 새싹들에게 기쁜 보물비를 뿌려주었을 때, 구름이의 몸은 왜 솜사탕보다 더 눈부시게 빛났을까요?",
        ...
        "aiSuggestions": [
          "구름이가 비가 되어 사라진 것인가요, 아니면 다시 구름으로 복귀하나요?",
        ...
        "cartoonCuts": [
          ...
          {"cut": 6, "emoji": "⛈️", "caption": "미세 먼지 친구들을 껴안고 어두운 비구름으로 변신!"},
      ...
      },
      {
        "key": "parents",
        "title": "🏡 7일차: 공부 습관",
        "headline": "작은 미션이 주는 기적 — 자율성과 성취감",
        "dek": "부모님과 함께 매일 스스로 세우는 학원 등원 공부 계획판의 자람 일기.",
        "body_md": "많은 어린이들이 공부를 '엄마와 선생님이 억지로 시켜서 하는 숙제'라고 착각합니다. 하지만 진짜 공부의 마법은 내 의지로 시작할 때 발휘됩니다.\n\n### 1. 성취감의 짜릿한 비밀\n내가 직접 \"오늘은 15분 동안 과학 터널 기사를 정독하고 생각의 씨앗 답변을 한 줄 써야지!\" 하고 스스로 계획을 수립해 보세요. 그리고 남의 참견 없이 내 힘으로 미션을 마쳤을 때 뇌 속에서 뿌듯한 **성취감**이 분출됩니다.\n\n### 2. 자율성은 공부의 엔진\n남이 시키는 것만 하는 기계 로봇이 아니라, 스스로 무엇이 필요한지 생각하고 행동에 옮기는 것을 **자율성**이라고 합니다. 매일 스스로 등원해서 한 페이지씩 챌린지를 마치는 작은 습관이 훗날 엄청난 자신감을 가진 우등생으로 자라게 하는 가장 강력한 씨앗입니다.",
        "future_note": "오늘 학원을 마칠 때 챌린지 카드에 찍힌 오늘의 진도 도장을 확인하며 '오늘 하루도 스스로 잘해냈다!' 하고 내 마음을 스스로 꼭 안아주며 칭찬해 주세요.",
        "thoughtQuestions": [
          "오늘 학원에 등원해서 내 계획대로 스스로 완수한 첫 번째 과제는 무엇이며, 해냈을 때 기분은 어땠나요?",
    ...
    "corners": [
      {
        "key": "cover",
        "title": "🔬 1일차: 과학 탐험",
        "headline": "식물 뿌리와 땅속 산소 공급 — 토양 환경",
        "dek": "지렁이 통로의 투수성과 투기성이 식물 성장에 미치는 영향.",
        "body_md": "식물은 햇빛과 잎사귀만으로 살아갈 수 없습니다. 보이지 않는 땅속의 **뿌리** 또한 산소를 필요로 합니다.\n\n### 1. 뿌리의 세포 호흡\n식물의 뿌리도 생물이기 때문에 산소를 마시고 이산화탄소를 내뱉는 호흡을 해야 에너지를 낼 수 있어요. 만약 마당 화단이 흙으로만 빽빽하고 딱딱하게 메말라 있으면 틈새 공기가 사라져 뿌리가 질식하고 말아요.\n\n### 2. 지렁이 통로의 과학적 가치\n지렁이가 땅을 파헤치며 기어간 자리에는 많은 공기 구멍(터널)이 생깁니다. 이를 통해 산소가 땅속 깊숙이 유입되고, 비가 내릴 때 물이 뭉치지 않고 깊은 곳까지 골고루 투수되는 최상의 환경이 만들어집니다. 지렁이는 천연 토양 산소 주입기 역할을 해주는 고마운 존재입니다.",
        "future_note": "비가 세차게 와서 흙 틈새가 물로 가득 차면 흙 속의 공기가 모두 사라져 지렁이들이 숨을 쉬기 위해 지표면 밖으로 탈출하는 신기한 자연 현상을 관찰할 수 있어요.",
        "thoughtQuestions": [
          "만약 공원 마당의 흙을 보존하지 않고 모두 시멘트 포장으로 가려버린다면 지하 토양 생태계는 어떻게 변할까요?",
        ...
        "aiSuggestions": [
          "식물 뿌리가 숨을 못 쉬어 질식하면 잎은 어떻게 변해요?",
      ...
      },
      {
        "key": "math",
        "title": "📐 2일차: 수학 놀이터",
        "headline": "우리 주변의 도형 기하학 — 평행과 입체도형",
        "dek": "평면에서 입체 공간으로 확장되는 도형의 쓰임새와 구조 설계의 기본 원리를 깨달아 보아요.",
        "body_md": "우리가 마주하는 세상은 평면을 넘어 삼차원 입체 도형으로 채워져 있습니다.\n\n### 1. 평행의 과학\n두 선이 아무리 길게 늘려도 영원히 서로 만나지 않는 것을 **평행**이라고 해요. 도로의 차선, 철도의 레일은 모두 완벽한 평행을 이루고 있어요. 만약 차선이나 선로가 비뚤어져 마주친다면 탈선 사고가 발생하겠지요?\n\n### 2. 삼각형이 버티는 건축적 지혜\n다리나 건물의 천장은 네모가 아니라 세모(삼각형) 뼈대로 만들어집니다. 삼각형은 모서리를 이어 붙였을 때 외력에 대해 형태의 유연성과 복원력이 뛰어나 찌그러지지 않고 가장 튼튼하게 하중을 버티는 기하학적 특징이 있습니다.",
        "future_note": "사방을 둘러보고 벽면의 가로선과 세로선이 평행과 수직을 어떻게 유지하는지 체크해 보세요.",
        "thoughtQuestions": [
          "철도 레일이 완벽한 평행선이 아니고 조금이라도 엇갈려 벌어진다면 열차 운행 시 어떤 위험이 생길까요?",
        ...
        "aiSuggestions": [
          "평행사변형은 마주보는 두 쌍의 변이 평행한데 사각형과 어떤 점이 다른가요?",
      ...
      },
      {
        "key": "hangeul",
        "title": "✍️ 3일차: 우리말 보물",
        "headline": "글의 완성도를 높이는 말솜씨 — 생동감을 주는 표현",
        "dek": "정확한 흉내말을 구사하여 나의 일기와 글짓기에 생기를 불어넣는 창작 놀이.",
        "body_md": "나의 생각이나 상황을 글로 적을 때, 더 실감 나는 문장을 만들기 위해 소리를 본뜬 **의성어**와 움직임을 묘사한 **의태어**를 적재적소에 사용하는 법을 연습해 봅시다.\n\n### 1. 듣는 재미를 선사하는 소리 묘사\n물이 세게 흐를 때는 *콸콸*, 낙엽을 살포시 지르밟을 땐 *바스락바스락*처럼 소리를 글로 전달하면, 독자는 현장에서 직접 듣는 듯한 착각에 빠집니다.\n\n### 2. 보는 즐거움을 주는 묘사\n토끼가 가볍게 도약하는 *깡충깡충*, 눈이 예쁘게 내리는 *함박보슬*처럼 시각을 언어화하면 상상력이 무한히 자극을 받습니다. 감정이 풍부한 어린이는 풍성한 흉내말로 고운 문장을 지어냅니다.",
        "future_note": "오늘 작성할 일기나 메모 한 줄에 반드시 내가 만든 신선한 의성어와 의태어를 포함시켜 문장을 다채롭게 꾸며 보세요.",
        "thoughtQuestions": [
          "아침 이슬이 풀잎에 이쁘게 맺혀 똑 굴러 떨어지는 소리와 모양을 나만의 단어로 예쁘게 창조한다면?",
        ...
        "aiSuggestions": [
          "비바람이 사납게 불어 칠 때 나는 여러 가지 소리들을 한글 단어로 추천해줘",
      ...
      },
      {
        "key": "english",
        "title": "🆎 4일차: 영어 소리나라",
        "headline": "Speech Rhythm of Logan — 영어 문장의 리듬과 조음 요령",
        "dek": "미국 초등학교 교실에서 사용하는 구어 리듬을 체화하며 원어민 같은 부드러운 스피치 발음을 얻어요.",
        "body_md": "영어는 음표를 연주하듯이 강세와 멜로디에 맞추어 읽는 언어입니다.\n\n### 1. 단어의 결을 맞추는 소리 놀이\n미국 친구들이 숙제를 순식간에 끝마쳤을 때 외치는 귀여운 표현으로 **\"Easy peasy lemon squeezy!\" (이지 피지 레몬 스퀴지!)**가 있습니다. 단어들의 뒤꽁무니 소리가 똑같이 리듬감 있게 떨어져서 리드미컬하고 자연스러운 회화 연습이 됩니다.\n\n### 2. 영어 억양 발음의 비법\n영어는 강조하고 싶은 핵심 단어(명사, 동사)를 **세게** 밀어내고, 약한 조사나 조동사는 발음을 죽여 조용히 지나갑니다.\n특히 **L** 발음으로 시작하는 단어를 구사할 때는 혀의 앞부분을 입천장 앞쪽에 밀착했다가 떼면서 살짝 **'(우)'** 소리를 미리 장착하고 튕겨내 보십시오. 원어민 특유의 조음 메커니즘을 터득하게 됩니다.",
        "future_note": "영어 단어 'Lemon'을 그냥 '레몬'으로 밟아 말하기보다, 혀를 윗니 뒤에 붙였다가 떼며 '(우)레~먼' 하고 굴려 말하며 리듬을 느껴보세요.",
        "thoughtQuestions": [
          "영어 문장 속의 강세가 들어간 단어가 한국말 발음보다 노래 가사처럼 길게 늘어나는 이유는 무엇일까요?",
        ...
        "aiSuggestions": [
          "L 발음 외에 R 발음을 굴릴 때 혀가 입천장에 닿지 않는 팁도 알려줘",
      ...
      },
      {
        "key": "future",
        "title": "🤖 5일차: 미래와 AI",
        "headline": "인공지능과 안전하게 놀기 — 프롬프트 마법사의 수호 규칙",
        "dek": "생성형 AI 시스템과 대화하고 협업할 때 내 소중한 사생활과 데이터를 철저히 방어하는 법을 익혀요.",
        "body_md": "우리가 학업에서 활용하기 시작한 **인공지능(AI)**은 사람의 명령을 흉내 내어 방대한 텍스트를 창작하는 똑똑한 비서입니다.\n그러나 AI는 입력받은 자료를 모아 외부 서버로 전송하므로, 우리의 수호 안전 준칙이 필요합니다.\n\n### 🔑 1단계 수호: 사생활 정보 가리기\nAI의 타이핑 입력창에 나의 진짜 신상 명세(**진짜 이름, 집 위치, 부모님의 전화번호, 우리 학교 이름**)는 절대 입력하지 않습니다. 개인정보 유출을 방지하기 위함입니다.\n\n### 🔑 2단계 수호: 현명한 별명으로 대화하기\n로봇과 대화할 때는 소중한 진짜 나를 보호하기 위해 귀여운 가상 캐릭터의 **'별명'**을 정해 대화를 건네는 현명함을 실천해 보세요. 삐뽀 로봇 친구도 훨씬 신나게 안전한 대답을 돌려줄 거예요.",
        "future_note": "비밀번호는 나만의 성을 지키는 튼튼한 성문과 같아요. 생일이나 1234 같은 쉬운 숫자 대신 문자와 숫자를 섞은 복잡한 조합을 쓰는 버릇을 가집시다.",
        "thoughtQuestions": [
          "나의 개인정보가 인공지능 서버를 타고 전 세계 인터넷 공간으로 흘러 나간다면 어떤 곤란한 일이 벌어질까요?",
      ...
      },
      {
        "key": "fairytale",
        "title": "☁️ 6일차: 상상 동화방",
        "headline": "꼬마 구름이의 나눔 여행 — 이타심이 가져온 기적",
        "dek": "자신의 소중한 형태를 버리고 시들어가는 생명들에게 빗방울을 뿌려준 꼬마 구름이의 행복 성장 동화.",
        "body_md": "구름 마을의 '구름이'는 알록달록 무지개 빛깔로 향긋한 설탕 향을 내뿜는 **솜사탕**을 보며 질투심을 느꼈어요. 아무리 맛을 봐도 밍밍한 구름에 불과한 자신이 싫어서 밤새도록 모양을 가꾸며 울상이었지요.\n\n그러던 한여름, 땅밑 화단의 아기 꽃과 새싹들이 폭염 속에 말라 죽기 일보 직전이었어요. 새싹들은 목이 말라 기력을 잃어 가고 있었지요. 구름이는 결심했습니다. \"내가 솜사탕처럼 달콤하게 빛나지 못하더라도, 내 모든 수분을 쏟아 저 목마른 새싹 친구들을 살릴 테야!\"\n\n구름이는 기꺼이 온몸을 어두운 비구름으로 팽창시켰고 시원하게 비를 대지에 쏟아부었습니다. 빗방울을 마시고 초록빛으로 파릇파릇 춤추는 새싹 정원을 내려다보며 구름이는 솜사탕보다 더 황홀한 무지개 행복을 깨달았습니다. 남을 이타적으로 돕는 순간이 나를 가장 빛나게 채워준다는 진리였습니다.",
        "future_note": "구름이는 자신을 양보하여 대지를 구하는 고귀한 가치를 얻었습니다. 진정한 나의 멋은 화려한 겉모습이 아닌 이타적인 행동에서 우러나옵니다.",
        "thoughtQuestions": [
          "꼬마 구름이의 밍밍했던 물방울들이 새싹을 살리는 단비로 승격되었을 때 구름이의 자존감은 어떻게 자라났을까요?",
        ...
        "aiSuggestions": [
          "구름이가 솜사탕을 질투했던 감정을 극복할 수 있었던 마음의 계기는 무엇인가요?",
      ...
      },
      {
        "key": "parents",
        "title": "🏡 7일차: 공부 습관",
        "headline": "나만의 독서록과 플래너 쓰기 — 메타인지의 시작",
        "dek": "내 손으로 매일 등원 약속을 점검하고 플래너에 진도를 기입할 때 마법 같은 공부 머리가 발현됩니다.",
        "body_md": "우수한 학생들은 매일 아침 혹은 등원 시점에 \"오늘 내가 마쳐야 할 과제 리스트\"를 노트나 플래너에 적어 확인하는 좋은 버릇을 유지합니다.\n\n### 1. 공부의 핸들, 자율성\n누군가 시켜서 하는 일은 두뇌의 능률을 떨어뜨리지만, 내가 목표를 통제하면 학습 능력이 비약적으로 상승해요. \n\n### 2. 뿌듯한 성취감과 메타인지\n공부를 마친 뒤 체크마크를 완성할 때, 우리의 신경망은 깊은 성취감과 공부를 이해했는지 점검하는 힘을 얻게 됩니다. 매일 작은 한 페이지를 완성하는 챌린지가 나를 최고의 인재로 자라게 해주는 가장 훌륭한 엔진입니다.",
        "future_note": "등원 플래너의 목표를 성공적으로 마칠 때마다 달콤한 칭찬 딱지를 내 이름 옆에 붙여 스스로를 당당하게 가꾸어 가세요.",
        "thoughtQuestions": [
          "오늘 등원해서 내 플래너에 가장 먼저 기록하고 완료한 내 힘으로의 학습 미션은 무엇인가요?",
        ...
        "aiSuggestions": [
          "공부 플래너를 쓰면 왜 내일 공부가 더 쉽고 가벼워지나요?",
    ...
    "corners": [
      {
        "key": "cover",
        "title": "🔬 1일차: 과학 탐험",
        "headline": "토양 생태계와 물질의 순환 — 분해자의 역할",
        "dek": "생태계 속 보이지 않는 청소부들이 만들어내는 완벽한 자연의 화학 정화 메커니즘을 알아봅니다.",
        "body_md": "우리가 밟고 서 있는 대지는 무수한 유기 화합물과 생물들이 상호작용하는 거대한 **생태적 화학 발전소**입니다.\n\n### 1. 생태계의 분해자들\n식물이 광합성을 통해 만든 영양분은 동물에게 이동하고, 결국 죽음을 맞이하면 땅속의 **분해자(미생물, 곰팡이, 지렁이)**들이 이를 수거해 무기물 상태로 분해하여 다시 식물 뿌리가 흡수할 수 있는 양분으로 환원시킵니다. 이 순환이 멈추면 지구는 거대한 쓰레기장으로 변할 것입니다.\n\n### 2. 지렁이의 생태적 지위와 통기성\n지렁이가 낙엽을 섭취해 배설하는 배설물(분변토)은 토양의 물리적/화학적 조성을 중성으로 중화시키고, 질소와 인산 같은 무기 영양소를 대폭 증폭시킵니다. 또한 지렁이가 뚫고 지나간 무수한 통로들은 흙의 다공성(구멍이 숭숭 뚫린 성질)을 극대화하여 식물 뿌리의 원활한 세포 호흡과 물 빠짐(투수성)을 촉진합니다.",
        "future_note": "비가 세차게 와서 흙 속에 물이 들어차 흙 틈새의 기공이 침수되면 지렁이는 피부 호흡을 지속할 수 없어 질식을 면하기 위해 지상으로 대피하게 됩니다.",
        "thoughtQuestions": [
          "토양 속 분해자가 전부 전멸하여 낙엽과 사체가 썩어 흙으로 돌아가지 못하면 육상 생태계는 어떻게 마비될까요?",
        ...
        "aiSuggestions": [
          "지렁이가 피부 호흡을 하려면 몸이 왜 항상 촉촉하게 젖어 있어야 하나요?",
      ...
      },
      {
        "key": "math",
        "title": "📐 2일차: 수학 놀이터",
        "headline": "기하학의 구조적 역학 — 삼각형과 면적의 공식",
        "dek": "삼각형의 기하학적 비일그러짐(강성)과 평행선 설계가 다리나 건축물의 안전에 미치는 역학 관계.",
        "body_md": "우리가 무심코 이용하는 대교나 빌딩 구조 속에는 엄밀한 기하학의 기계공학적 원리가 함축되어 있습니다.\n\n### 1. 삼각형의 기하학적 불변성(강성)\n사각형이나 다각형 구조물은 연결 부위가 자유롭게 움직일 수 있어 외부 압력을 가하면 평행사변형 형태로 아주 쉽게 일그러집니다. 반면, **삼각형**은 세 변의 길이만 정해지면 단 하나의 고정된 고유한 형태를 형성하여, 꼭짓점에 강한 힘이 집중되어도 모양이 전혀 뒤틀리지 않는 최상의 구조적 안정성(트러스 구조)을 지닙니다.\n\n### 2. 평행과 수직의 도로 설계\n레일이나 기찻길이 유지하는 **평행**은 영원히 만나지 않고 동일 거리를 두는 평면의 성질입니다. 이를 어길 시 열차는 탈선하게 됩니다. 평면 기하학의 기본 공식을 기반으로 정밀한 도시 인프라가 설계됩니다.",
        "future_note": "집 주위의 공사장 크레인이나 철제 지붕, 송전탑을 보며 어떠한 방식으로 촘촘히 엮인 삼각형들이 중력을 버티는지 탐색해 보세요.",
        "thoughtQuestions": [
          "만약 대교 다리의 기둥이나 트러스가 삼각형이 아닌 단순 마름모나 사각형으로만 용접된다면 구조물 붕괴 위험은 어떻게 높아질까요?",
        ...
        "aiSuggestions": [
          "삼각형이 외력에 대해 절대 찌그러지지 않는 수학적 수학 공식과 비결은 무엇인가요?",
      ...
      },
      {
        "key": "hangeul",
        "title": "✍️ 3일차: 우리말 보물",
        "headline": "의성어와 의태어 — 한글의 흉내말 속에 깃든 글쓰기의 비법",
        "dek": "한글 고유의 풍성한 시청각적 흉내말을 탐색하고 문맥 속에서 문장력을 다채롭게 완성합니다.",
        "body_md": "우리 한글은 닿소리와 홀소리의 결합을 통해 대자연의 현상을 가장 소름 끼치도록 가깝게 모사할 수 있는 높은 표음 문자적 특징을 지닙니다.\n\n### 1. 묘사의 생동감을 주는 표현\n물이 쏟아지는 소리를 *콸콸콸*, 낙엽을 밟을 때의 소리를 *바스락바스락*과 같이 묘사해 주는 **의성어**를 쓰면 문장의 청각적 몰입감이 고조됩니다.\n\n### 2. 모션을 그리는 언어\n소리는 안 나지만 토끼가 도약하는 모습을 *깡충깡충*, 비가 보드랍게 오는 모습을 *보슬보슬*과 같이 나타내 주는 **의태어**를 적절히 활용하면, 독자는 텍스트를 읽는 즉시 뇌 속에서 영화를 보듯 그림을 연상해 냅니다. 고운 우리말 어휘들을 문맥 속에 영리하게 배치하면 생명력 넘치는 문장가가 됩니다.",
        "future_note": "오늘 작성할 일기나 작문 연습장에 반드시 새로운 의성어/의태어를 3개 이상 삽입하여 감칠맛 나는 문장 표현을 완성해 보십시오.",
        "thoughtQuestions": [
          "비바람이 휘몰아치며 유리창에 빗방울이 부딪혀 흐르는 극적인 상황을 나만의 생생하고 새로운 흉내말로 표현해 봅본다면?",
        ...
        "aiSuggestions": [
          "가을바람이 마른 잎사귀들을 흔드는 섬세한 동작을 표현하는 우리말 의태어를 추천해줘",
      ...
      },
      {
        "key": "english",
        "title": "🆎 4일차: 영어 소리나라",
        "headline": "Rhythm of Logan — 영어 구어의 강세 박자와 발음 꿀팁",
        "dek": "미국 어린이들이 일상에서 체득하는 강세 박자 언어(Stress-timed)의 원리와 L 음소의 올바른 조음 기법.",
        "body_md": "한국어는 음절 하나마다 일정한 힘과 길이를 부여하지만, 영어는 파도치듯 강약 조절로 흐름을 이어가는 음악적 언어입니다.\n\n### 1. 발음의 리듬감, 라임\n미국인들이 껌 씹듯 가볍게 뱉는 표현인 **\"Easy peasy lemon squeezy!\" (이지 피지 레몬 스퀴지!)**를 소리 내어 보십시오. 각 단어들의 음절 끝소리가 정교하게 맞아떨어지는 라임(Rhyme) 구조를 띠고 있어, 멜로디처럼 흥겨운 미국식 억양 습득의 최고 텍스트가 됩니다.\n\n### 2. 원어민 L 발음의 메커니즘\n영어 문장 속에서는 주요 단어를 **크고 세게** 말하는 대신 접속사나 관사 같은 문법 단어는 바람 빠지듯 슥 묻어가야 자연스럽습니다.\n특히 단어 앞에 **L** 발음이 올 땐, 그냥 'ㄹ'로 부르기 전에 혀끝을 윗니 뒤쪽 잇몸 뼈에 바짝 압착했다가 튕겨내며 앞에 **'(우)'** 소리를 찰나로 장전해 봅니다. 조음 기관의 정밀한 위치 설정을 통해 완벽한 미국식 영어 결을 얻게 됩니다.",
        "future_note": "영어 단어 'Lovely'를 한글 읽듯 '러블리'로 또박또박 밟기보다, 혀를 압착했다 튕기며 '(우)러~블리'로 강세를 주어 훈련하세요.",
        "thoughtQuestions": [
          "영어의 멜로디 억양(Intonation)을 무시한 채 로봇처럼 균일한 높낮이로 영어 책을 읽으면 원어민들은 왜 난감해할까요?",
        ...
        "aiSuggestions": [
          "L 발음과 R 발음을 구별하여 조음할 때 혀와 입모양의 결정적 차이를 쉽게 강의해줘",
      ...
      },
      {
        "key": "future",
        "title": "🤖 5일차: 미래와 AI",
        "headline": "인공지능과 데이터 보안 — 소중한 나의 개인정보 보호",
        "dek": "생성형 AI 모델의 학습 원리를 파악하고, 프롬프트 입력창을 통한 디지털 개인정보 침해 예방 대책을 탐구합니다.",
        "body_md": "우리가 다양한 과제를 해결하기 위해 활용하는 **인공지능(AI)**은 방대한 텍스트와 인간의 대화를 흡수하여 예측하는 초거대 언어 컴퓨터 모델입니다.\n하지만 우리가 입력창에 쓰는 모든 문장이 AI의 학습 데이터로 귀속되므로 철저한 보안의식이 필요합니다.\n\n### 🔑 개인 식별 정보(PII)의 안전 통제\nAI 프롬프트 창에 나의 진짜 신상(**실명, 휴대폰 번호, 집 주소, 학교 학년 반, 비밀번호**)을 타이핑하면 해당 정보가 학습 인프라에 누적되어 다른 타인의 답변으로 노출될 우려가 있습니다.\n\n### 🔑 닉네임 기반의 익명 대화 요령\n나의 프라이버시를 지키는 가장 지혜로운 방법은 AI를 사용할 때 가상의 **'별명'**을 설정하여 질문을 건네는 것입니다. 사생활 침해 위험을 완벽히 소거하면서도 똑똑하게 AI 로봇을 비서로 부려 먹을 수 있습니다.",
        "future_note": "비밀번호는 개인정보 요새를 수호하는 최후의 방벽입니다. 생일이나 0000 같은 유추하기 쉬운 문자를 완전히 기피하고 대소문자, 숫자 혼합 형태로 셋업해야 안전합니다.",
        "thoughtQuestions": [
          "인공지능 서비스에 아무 생각 없이 나의 사생활 일기를 가감 없이 적어넣을 때 발생할 수 있는 보안적 허점은 무엇인가요?",
        ...
        "aiSuggestions": [
          "나의 데이터 정보가 AI 학습을 타고 외부로 유출되는 진짜 내부적 메커니즘을 알려주세요",
      ...
      },
      {
        "key": "fairytale",
        "title": "☁️ 6일차: 상상 동화방",
        "headline": "꼬마 구름이의 나눔 여행 — 이타성의 자람",
        "dek": "솜사탕의 화려함을 부러워하던 꼬마 구름이가 시들어가는 새싹 정원에 자신을 던져 이타적 행복을 발견하는 이야기.",
        "body_md": "구름 나라 구름이는 놀이공원의 향긋한 노란 솜사탕을 질투했습니다. 물로 뭉쳐진 밍밍한 구름인 자기 모습이 초라해서 바람에 모양이 흐트러질 때마다 속상해 울곤 했지요.\n\n그러다 폭염 아래 노랗게 말라가는 화단 새싹들의 애원을 들었습니다. 구름이는 결심했습니다. \"내가 솜사탕처럼 화려하게 사랑받지 못하더라도, 시들어가는 아기 새싹들을 구하기 위해 단비가 될 테야!\" 구름이는 먼지를 품어 안고 기꺼이 어두운 비구름이 되었고, 촉촉한 보슬비를 쏟아 대지에 뿌렸습니다. 파릇파릇 살아나 춤추는 새싹들을 보며, 구름이는 솜사탕 맛보다 훨씬 고귀한 '이타성'의 행복을 깨닫게 되었습니다.",
        "future_note": "비 온 뒤 대지는 구름이의 소중한 나눔으로 아름답게 가꾸어졌습니다. 진정한 나의 고귀함은 겉치장이 아닌 남을 향한 다정한 이타심에서 나옵니다.",
        "thoughtQuestions": [
          "구름이가 솜사탕이 되는 것보다 비가 되어 내린 걸 더 기뻐한 내면의 가치 변화는 무엇인가요?",
      ...
      },
      {
        "key": "parents",
        "title": "🏡 7일차: 공부 습관",
        "headline": "공부 주도권 쥐기 — 자율성과 나만의 성취감",
        "dek": "부모님과 학원 등원 시 오늘의 학습 계획을 자율적으로 통제할 때 공부 머리가 폭발합니다.",
        "body_md": "우수한 아이들은 공부를 '부모님이 억지로 시킨 고통의 벌칙'으로 방치하지 않습니다.\n\n### 1. 공부의 핸들을 쥐세요\n내가 자율적으로 \"오늘은 20분 동안 이 지렁이 과학을 읽고 글을 쓸 테니 간섭하지 말아 주세요!\" 하고 약속을 걸어보세요. 내 힘으로 끝까지 과제를 마칠 때 분비되는 도파민은 뇌세포에 최고의 뿌듯한 **성취감**을 안깁니다.\n\n### 2. 자신감을 키우는 자율성\n누군가 조종하는 꼭두각시 로봇이 아닌 내 공부의 절대적인 주인이 되는 훈련을 매일 등원 챌린지 도장을 채우며 한 걸음씩 밟아가 보십시오. 이 힘이 훗날 엄청난 성장 동력입니다.",
        "future_note": "오늘 스스로 완수한 독서록 과제를 점검하며 '스스로 해내는 나의 능력은 대단하다!' 하고 내 자신을 자랑스러워해 주세요.",
        "thoughtQuestions": [
          "오늘 자율적으로 기획하여 스스로 끝을 낸 최고의 등원 미션은 무엇인가요?",
        ...
        "aiSuggestions": [
          "스스로 목표를 설정하고 피드백을 주는 메타인지의 비밀 공식은?",
    ...
    "corners": [
      {
        "key": "cover",
        "title": "🔬 1일차: 과학 탐험",
        "headline": "토양 생태계와 물질의 순환 — 분해자의 생태적 복원력",
        "dek": "땅속 유기물 분해 작용과 토양 산성화 방지 메커니즘을 토대로 환경 과학을 조명해 봅니다.",
        "body_md": "토양은 단순한 무기 광물이 아니라, 무수한 미생물과 화학 반응이 공존하는 **생태계의 역동적인 화학 실험실**입니다.\n\n### 1. 토양 생태계의 물질 순환\n지표면의 낙엽, 동물의 사체와 배설물 같은 유기물은 토양 내 **분해자(미생물, 곰팡이, 지렁이)**의 생화학적 환원 작용을 거쳐 무기 양분으로 쪼개집니다. 이 양분은 식물의 뿌리로 흡수되어 새로운 식물체를 이루고, 초식동물의 영양원으로 이어집니다. 이 분해자들의 메커니즘이 결여된다면 대지는 물질 순환의 동력을 잃어 고사할 것입니다.\n\n### 2. 토양 산성화 방지와 지렁이\n지렁이는 흙을 삼켜 장 내 소화관을 거치는 동안 탄산칼슘을 분비하여 산성화된 토양의 pH 농도를 식물이 살기 가장 좋은 중성(pH 6.5~7.0) 상태로 중화시키는 조절자 역할을 수행합니다. 또한, 지렁이의 끊임없는 굴착 활동은 토양의 다공성(Porosity)을 증대시켜 식물 뿌리의 원활한 산소 공급과 수분의 지하수 저장력을 크게 향상시켜 주는 토양 물리 공학의 귀중한 주역입니다.",
        "future_note": "기습적인 집중호우로 토양 속 공극(기공)이 빗물로 완전히 침수되면, 지렁이는 생존 한계에 부딪혀 피부 호흡을 하기 위해 지상으로 대대적으로 기어 나오는 생태적 탈출 현상을 보입니다.",
        "thoughtQuestions": [
          "토양 내 분해자들의 순환 메커니즘이 단절되어 낙엽과 고사목이 지표면에 끝없이 적체된다면 탄소 순환에는 어떠한 교란이 발생할까요?",
        ...
        "aiSuggestions": [
          "지렁이가 분비하는 탄산칼슘이 산성 토양을 중화하는 구체적인 화학 반응 메커니즘은 무엇인가요?",
      ...
      },
      {
        "key": "math",
        "title": "📐 2일차: 수학 놀이터",
        "headline": "기하학적 설계와 공학적 안정성 — 원주율(Pi)과 하중 분산",
        "dek": "원주율(Pi)의 역사적 유래와 현수교, 에펠탑 트러스 구조에 숨겨진 삼각형의 하중 분산 기하학을 탐색합니다.",
        "body_md": "우리가 지나다니는 교량과 수천 톤을 버티는 초고층 빌딩에는 엄격한 기하학의 역학적 비밀이 내포되어 있습니다.\n\n### 1. 영원한 상수, 원주율(Pi)\n원의 둘레(원주)를 원의 지름으로 나눈 비율인 **원주율(π = 3.141592...)**은 원의 크기와 관계없이 항상 동일한 기하학적 불변 법칙을 나타냅니다. 고대 바빌로니아 시대부터 탐구되어 온 파이(π)는 바퀴의 회전 정밀성, 기계 기어 설계의 완벽한 둥근 물리 성질을 완성하는 기초가 되었습니다.\n\n### 2. 삼각형 트러스 구조와 하중 분산\n사각형 구조물은 좌우 횡압력을 받을 때 내부 접합부의 모멘트로 인해 매우 평행사변형처럼 찌그러지기 쉽습니다. 반면, **삼각형**은 세 꼭짓점이 기하학적으로 고정된 형태를 이루어, 수직 방향으로 무거운 압력을 받아도 각 변과 모서리가 인장력과 압축력을 골고루 분담해 찌그러지지 않고 견디는 최고의 기하학적 안정성을 자랑합니다.",
        "future_note": "주변에 있는 철골 타워나 송전탑, 혹은 자전거 휠 스포크 구조를 유심히 관찰하며 삼각형 기하학이 어떻게 힘을 나누는지 직접 조사해 보십시오.",
        "thoughtQuestions": [
          "원주율이 상수가 아닌 크기에 따라 변하는 변수였다면 정밀 기계와 우주선 궤도 계산에는 어떤 재앙적 오류가 생겼을까요?",
        ...
        "aiSuggestions": [
          "삼각형 3변의 결정 조건이 왜 물리적 강성(찌그러지지 않는 힘)과 직접적으로 연결되나요?",
      ...
      },
      {
        "key": "hangeul",
        "title": "✍️ 3일차: 우리말 보물",
        "headline": "의성어와 의태어 — 뇌를 자극하는 시청각적 언어의 힘",
        "dek": "한글 흉내말을 구조적으로 분석하여 문장 작성에 풍성한 심미적 입체감을 부여하는 기법을 배웁니다.",
        "body_md": "한글은 음소의 조합을 통해 외부 물리적 소리 리듬과 눈으로 감각하는 동작의 시각적 형태를 기적과 같이 묘사할 수 있는 독보적인 문학적 잠재력을 지니고 있습니다.\n\n### 1. 청각적 묘사의 논리적 배치\n계곡물이 쏟아지는 소리는 *콸콸콸*, 낙엽을 지르밟는 미세한 사각거림은 *바스락바스락*과 같은 **의성어**로써 재현하여, 글에 역동적인 사운드를 주입해 생동감 넘치는 문장을 구현합니다.\n\n### 2. 시각 감각의 문학적 변환\n소리가 없어도 토끼의 가벼운 도약을 표현하는 *깡충깡충*, 눈이 부드럽게 대지를 덮는 모습을 그리는 *보슬보슬*과 같은 **의태어**는 인간의 뇌 속에서 복잡한 회화적 상상력을 단숨에 유도하는 강력한 언어적 코드입니다. 고운 낱말들을 깊이 있게 수집하여 문장 속에 논리적으로 버무려 넣을 때 영혼을 울리는 위대한 문장가로 성장하게 됩니다.",
        "future_note": "오늘 쓰는 글짓기 혹은 학습 일기장에 한글 고유의 의성어와 의태어를 고도로 다듬어 최소 3문장 이상을 유려하게 적어 내려가 보세요.",
        "thoughtQuestions": [
          "대폭풍우가 치는 어둡고 무시무시한 기상 이변 상황을 한글의 다양한 자모 조합을 사용하여 창의적인 뉴 흉내말로 고안한다면?",
        ...
        "aiSuggestions": [
          "바람이 눈 덮인 나뭇가지 사이를 통과할 때의 소리와 풍경을 묘사하는 문학적 의성어를 추천해줘",
      ...
      },
      {
        "key": "english",
        "title": "🆎 4일차: 영어 소리나라",
        "headline": "Speech Rhythm of Logan — 영어 구어 리듬의 역사와 강세 박자",
        "dek": "영어 구어의 핵심 특징인 강세 박자 언어(Stress-timed)의 물리학적 원리와 원어민 L 발음의 조음 기법.",
        "body_md": "영어 말하기를 정밀하게 습득하기 위해서는 한국어 특유의 '음절 박자(Syllable-timed)' 버릇을 버리고, 피치를 타고 노래하듯 튕기는 '강세 박자(Stress-timed)' 구조를 이해해야 합니다.\n\n### 1. 구어의 조화로운 라임, 주문놀이\n미국인들이 아주 가벼운 미션을 단숨에 끝냈을 때 환호하듯 뱉는 표현인 **\"Easy peasy lemon squeezy!\" (이지 피지 레몬 스퀴지!)**가 대표적인 발음 훈련 교구입니다. 단어 끝의 라임(Rhyme)이 완벽하게 대칭을 이루어 영어 고유의 호흡과 기류를 느끼는 최고의 재료가 됩니다.\n\n### 2. 완벽한 L 조음을 위한 팁\n영어의 말소리는 의미를 지닌 주단어에 **강하고 뚜렷한 힘**을 실어 말하고 부수적인 기능어는 0.1초의 짧은 바람 소리로 스치듯 지나가야 조화롭습니다.\n특히 단어 첫머리에 **L** 발음이 등장할 땐 혀끝을 윗니 뒤쪽 돌기 뼈에 강력히 압착하여 기류를 잠시 차단했다가 내보내는 튕김 기법을 쓰십시오. 입술을 떼기 전 눈에 보이지 않는 **'(우)'**의 입모양과 예비음을 찰나로 장착하는 훈련이 원어민 발음으로 도약하는 비밀 열쇠입니다.",
        "future_note": "영어 단어 'Leader'를 말할 때 한국식 '리더'가 아니라 혀끝을 잇몸에 압착했다가 튕겨서 '(우)리~덜' 하고 부드럽게 발음해보세요.",
        "thoughtQuestions": [
          "강세를 넣지 않고 균일한 성조와 속도로 영어 텍스트를 나열할 때 원어민들이 언어 장벽을 느끼는 과학적 이유는 무엇인가요?",
        ...
        "aiSuggestions": [
          "L 발음 외에 R 조음 시 혀를 뒤로 당기면서도 절대 입천장에 접촉하지 않는 팁을 쉽게 설명해줘",
      ...
      },
      {
        "key": "future",
        "title": "🤖 5일차: 미래와 AI",
        "headline": "인공지능의 원리와 데이터 프라이버시 — 사이버 보안 준칙",
        "dek": "LLM(거대 언어 모델)의 학습 메커니즘을 규명하고, AI 프롬프트 창을 통한 데이터 보안 침해 예방안을 모색합니다.",
        "body_md": "우리가 다양한 정보를 획득하고 학습에 이용하는 **인공지능(AI)**은 인공신경망 알고리즘을 기반으로 한 거대 언어 모델(LLM)의 컴퓨터 신경 시스템입니다.\n하지만 우리가 타이핑하여 로봇에게 던지는 모든 문맥이 AI 개발사의 클라우드 데이터 서버로 흡수되므로 철저한 보안 통제가 필수적입니다.\n\n### 🔑 1단계 수호: 개인 식별 정보(PII)의 전면 필터링\nAI 프롬프트 창에 나의 진짜 신상 명세(**실제 이름, 상세 집 주소, 부모님의 전화번호, 학원 및 학교 이름, 인터넷 비밀번호**)는 절대 타이핑하여 발송해서는 안 됩니다. 해당 데이터가 학습 파라미터로 저장되어 다른 외부 사용자의 질문에 노출될 수 있는 중대한 개인정보 침해 요인이 됩니다.\n\n### 🔑 2단계 수호: 익명 계정과 가상 별명 대화법\n나의 안전과 데이터를 완벽히 보호하는 가장 현명한 실천법은 AI 로봇과 대화할 때 가상의 소중한 캐릭터 **'별명'**을 구축하는 것입니다. 삐뽀 로봇에게 가상의 닉네임으로 공부 지시를 건넬 때, 개인정보 노출 위험은 제로가 되면서 완벽한 학습 비서로 로봇을 길들일 수 있게 됩니다.",
        "future_note": "비밀번호는 나의 소중한 디지털 자산을 지키는 튼튼한 자물쇠와 같습니다. 유추하기 쉬운 번호는 절대 피하고 대소문자, 기호, 숫자를 융합한 복잡한 조합을 쓰는 보안적 습관을 갖춰야 합니다.",
        "thoughtQuestions": [
          "우리가 무심코 AI 입력창에 적어 넣은 나의 사생활 고민이나 일기장 데이터가 미래에 어떤 개인정보 노출 사고로 복귀될 우려가 있을까요?",
        ...
        "aiSuggestions": [
          "거대 언어 모델(LLM)이 인간의 질문 문맥 데이터를 수집해 학습에 반영하는 기술적 기전은?",
      ...
      },
      {
        "key": "fairytale",
        "title": "☁️ 6일차: 상상 동화방",
        "headline": "꼬마 구름이의 나눔 여행 — 이타성과 자기 수용",
        "dek": "화려한 겉모습을 동경하던 아기 구름이가 시들어가는 새싹 정원에 빗방울을 내리며 자아 성취에 이르는 성장 문학 동화.",
        "body_md": "구름 마을의 '구름이'는 알록달록 무지개 빛깔로 향긋한 설탕 향을 내뿜는 **솜사탕**을 보며 질투심을 느꼈어요. 아무리 맛을 봐도 밍밍한 구름인 자기 모습이 초라해서 바람에 모양이 흐트러질 때마다 속상해 울곤 했지요.\n\n그러다 폭염 아래 노랗게 말라가는 화단 새싹들의 애원을 들었습니다. 구름이는 결심했습니다. \"내가 솜사탕처럼 화려하게 사랑받지 못하더라도, 시들어가는 아기 새싹들을 구하기 위해 단비가 될 테야!\" 구름이는 먼지를 품어 안고 기꺼이 어두운 비구름이 되었고, 촉촉한 보슬비를 쏟아 대지에 뿌렸습니다. 파릇파릇 살아나 춤추는 새싹들을 보며, 구름이는 솜사탕 맛보다 훨씬 고귀한 '이타성'의 행복을 깨닫게 되었습니다.",
        "future_note": "비 온 뒤 대지는 구름이의 소중한 나눔으로 아름답게 가꾸어졌습니다. 진정한 나의 고귀함은 겉치장이 아닌 남을 향한 다정한 이타심에서 나옵니다.",
        "thoughtQuestions": [
          "구름이가 솜사탕이 되는 것보다 비가 되어 내린 걸 더 기뻐한 내면의 가치 변화는 무엇인가요?",
          "내가 친구에게 베푼 작은 배려로 인해 나조차 기쁨과 치유를 얻었던 기억이 있나요?"
      ...
      },
      {
        "key": "parents",
        "title": "🏡 7일차: 공부 습관",
        "headline": "메타인지 학습법과 효율적인 시간 배분 전략",
        "dek": "내가 아는 것과 모르는 것을 완벽히 구별하여 통제하는 메타인지적 공부 훈련의 기적을 알아봅시다.",
        "body_md": "상위 0.1%의 우등생들이 지닌 공통적인 특징은 뛰어난 지능지수(IQ)가 아니라 바로 자신에 대해 철저히 분석하는 **메타인지** 능력입니다.\n\n### 1. 내가 아는 것을 확인하는 법\n단순히 책을 눈으로 쓱 훑어보는 것은 아는 듯한 '착각'에 불과합니다. 진짜 이해했는지를 확인하려면 남에게 그 지식을 설명해보거나 독서 일기장에 나만의 주도적 핵심을 적어 내려가 봐야 합니다.\n\n### 2. 등원 챌린지로 습관의 뇌 만들기\n매일 학원에 등원해서 스스로 내 플래너에 체크마크를 표시할 때 뇌의 보상체계는 강력한 자존감과 지속적인 학습 동력을 뿜어냅니다. 자율적으로 이뤄지는 이 1%의 미세 조율이 미래에 기하학적인 성공을 이룩하는 최고의 습관입니다.",
        "future_note": "오늘 챌린지 답변을 쓰면서 내가 어느 부분에서 막혔고, 어떤 부분은 손쉽게 써냈는지 내 생각을 한 단계 위에서 유심히 들여다보십시오.",
        "thoughtQuestions": [
          "오늘 내가 이해한 챌린지 과학/수학 지식을 부모님이나 친구에게 30초 이내로 가장 쉽게 설명한다면 어떻게 정리할 수 있을까요?",
        ...
        "aiSuggestions": [
          "메타인지를 일상에서 훈련하여 공부 집중력을 2배 올리는 구체적 방법론은?",
