  ...
  "1": {
    ...
    "corners": [
      ...
      },
      {
        ...
        "dek": "로봇 친구와 대화할 때는 내 소중한 비밀번호 and 이름을 꼭 지켜주세요.",
        "body_md": "학습기나 폰에 있는 **인공지능 로봇**은 척척박사예요. 우리가 물어보는 질문에 뭐든지 답해주지요.\n\n### 1. 비밀을 지키는 약속\n하지만 로봇은 아주 똑똑한 컴퓨터라서 우리가 이야기한 비밀을 기억해 두었다가 다른 사람에게 전해줄 수도 있어요. 그래서 **내 진짜 이름, 집 주소, 비밀번호**는 절대로 이야기하면 안 돼요.\n\n### 2. 안전 약속 상자 만들기\n로봇과 공부할 때는 내 이름 대신 예쁜 **'별명'**을 정해서 대화해 보세요. 훨씬 안심하고 재미나게 놀 수 있어요.",
      ...
      },
      {
        ...
        "body_md": "구름 나라에 살던 꼬마 구름이는 달콤한 **솜사탕**이 되고 싶었어요.\n\"나도 알록달록 맛있게 변해서 아이들을 웃게 해줄래!\"\n하지만 아무리 흔들어도 달콤한 설탕 냄새가 나지 않았어요.\n\n어느 날, 뜨거운 햇빛 아래 꽃들이 목말라 울고 있었어요. 구름이는 결심했어요. \"내 모습을 양보해서 시들어가는 친구들을 도와줄래!\"\n구름이는 비를 가득 담은 먹구름이 되어 **보물비**를 땅 위에 부드럽게 내려주었답니다.",
      ...
      },
      {
        ...
        "dek": "매일 아카데미에 등원해서 스스로 과제를 완성하면 보물상자가 가득 차요.",
        "body_md": "멋진 어린이는 부모님이 시키지 않아도 스스로 나와의 약속을 지켜요.\n\n### 1. 내가 만든 보물지도\n매일 아카데미에 오자마자 자리에 앉아 오늘의 일기를 소리 내어 읽고 답변을 써보세요. 하나씩 완료할 때마다 스티커 보물상자에 예쁜 스티커가 붙는답니다.\n\n### 2. 스스로 자라는 자존감\n\"나는 약속을 스스로 잘 지키는 멋진 아이야!\" 하고 마음속으로 다짐해 봐요. 내 스스로 시작하는 작은 힘이 나중에 아주 큰 성공을 만들어 내요.",
  ...
  "2": {
    ...
    "corners": [
      ...
      },
      {
        ...
        "future_note": "오늘 부모님이나 아카데미 선생님께 인사할 때 엉덩이를 씰룩이며 \"Okey-dokey!\" 하고 귀엽게 영어 인사를 건네 보세요.",
        "thoughtQuestions": [
      ...
      },
      {
        ...
        "body_md": "하늘나라 솜사탕 가게가 열렸어요. 많은 아기 구름들이 알록달록 무지개 맛을 내며 하늘을 예쁘게 꾸몄답니다. 하지만 꼬마 구름 '구름이'는 아무런 단맛이 나지 않는 **밍밍한** 구름이었어요.\n\n구름이는 \"나도 달고 예뻐져서 아이들을 기쁘게 해줄래\" 하고 울먹였지만, 바람이 불자 모양마저 쉽게 망가지고 말았죠.\n\n그때 땅밑에서 더위에 축 늘어진 초록 새싹들이 \"목말라요, 흑흑\" 하며 울부짖었어요. 구름이는 결심했어요. \"내 모습을 버리더라도 저 어린 친구들을 도울래!\" 구름이는 아기 구름 친구들을 감싸 안은 기쁜 비가 되어 땅 위로 **보슬보슬** 쏟아져 내렸답니다. 시원하게 비를 머금은 새싹들은 뽀송뽀송 싹을 피워 기쁜 춤을 추었고, 그 풍경을 본 구름이는 솜사탕보다 훨씬 큰 행복한 미소를 지었답니다.",
  ...
  "3": {
    ...
    "corners": [
      ...
      },
      {
        ...
        "dek": "부모님과 함께 매일 스스로 세우는 아카데미 등원 공부 계획판의 자람 일기.",
        ...
        "future_note": "오늘 아카데미를 마칠 때 챌린지 카드에 찍힌 오늘의 진도 도장을 확인하며 '오늘 하루도 스스로 잘해냈다!' 하고 내 마음을 스스로 꼭 안아주며 칭찬해 주세요.",
        "thoughtQuestions": [
          "오늘 아카데미에 등원해서 내 계획대로 스스로 완수한 첫 번째 과제는 무엇이며, 해냈을 때 기분은 어땠나요?",
  ...
  "5": {
    ...
    "corners": [
      ...
      },
      {
        ...
        "dek": "부모님과 아카데미 등원 시 오늘의 학습 계획을 자율적으로 통제할 때 공부 머리가 폭발합니다.",
