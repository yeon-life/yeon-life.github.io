...
book_index_path = 'c:\\Claude\\연라이프\\yeon-life.github.io\\도서관\\완성책장\\001_ㄱㄴㄷ친구들이깨어났어요\\index.html'
...
if old_topbar in content:
    ...
    # Let's check if we can replace the buttons part
...
print("Patched 001_ㄱㄴㄷ친구들이깨어났어요 index.html successfully!")
